                ...
                <div className="sm:flex sm:items-start ">
                    ...
                    <div className="mt-3 sm:mt-0 sm:ml-4 w-full">
                        ...
                        {data ?
                            (hasDependencies ? (
                                <div className="mt-2">
                                    <p className="my-5">The following dependencies will
                                        need to be removed before deletion:</p>
                                    <div className="ml-2">
                            ...
                            : <div className="h-60 pr-6 w-full flex items-center justify-center"><Spinner size="lg" /></div>
                        }
                    </div>
                </div>
